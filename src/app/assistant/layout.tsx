...
const sidebarItems = [
  { href: "/assistant/dashboard", icon: LayoutDashboard, label: "Dashboard" },
  { href: "/assistant/tasks", icon: ClipboardList, label: "My Tasks" },
  { href: "/assistant/signs", icon: MapPin, label: "Signs" },
  { href: "/assistant/settings", icon: Settings, label: "Settings" },
];
...
export default function AssistantLayout({
  ...
  const { user, isLoading } = useRequireAuth("assistant");
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <Link href="/assistant/settings">Settings</Link>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
